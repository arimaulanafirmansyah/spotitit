...
function status()
	{
$fg = file_get_contents('https://amfcode.my.id/spotify');
$ex = explode('content="status:',$fg)[1];
$stat = explode(' -',$ex)[0];
if($stat=="online"){
	} else if($stat=="offile"){
		echo "  Server down, contact me at whatsapp: 6285157792618\n\n"; die;
	} else {
	echo "  403 Forbidden, contact me at whatsapp: 6285157792618\n\n"; die;
	}
}
...
echo "
	   ...
	   / __)(  _ \(  _  )(_  _)(_  _)( ___)( \/ )
	   \__ \ )___/ )(_)(   )(   _)(_  )__)  \  / 
	   (___/(__)  (_____) (__) (____)(__)   (__) \n"."              Samsung Galaxy Free 3 Month offer\n\n\n";

$status = status();
echo " Select the menu below";
echo "\n 1. Register and get Cookie Browser ";
echo "\n 2. Register and get Bearer Authorization app ";
echo "\n 3. Register and Claim Free Spotify 3 Month Samsung Galaxy ";
echo "\n  Choose : ";
$hai = trim(fgets(STDIN));
echo "  Your choice $hai";


reg:
echo "\n\n";
echo " Trying to register on spotify use random email ";
$email = randUser()."@amf.codes";
$pass = "Amfcode123";
...
if($x['isAnonymous'] == false)
	{
		$bearer = $x['accessToken'];
		echo "\n Successfully Grabber Bearer and Cookie <3";
	} else {
		var_dump("\n\n$hems\n\n");
		die;
	}
